...
--
-- Host: 127.0.0.1    Database: cti_dwp
-- ------------------------------------------------------
...
CREATE TABLE `parametros` (
  ...
  `plugin_instagram` longtext,
  `plugin_facebook` longtext,
  `analytics` longtext,
  `theme_colour` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuarios` VALUES (1,'Administrador',NULL,'admin@admin.com',1,'e10adc3949ba59abbe56e057f20f883e','2018-05-01 00:00:00',NULL);
...
-- Dump completed on 2018-05-22  9:12:53
