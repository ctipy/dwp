...
if (isset($_POST['insertar']))
{
    ...
    {
      $sql = $connection->prepare('INSERT INTO slides (`name`, `target`, `url`, `image`, `image_mobile`, `active`, `visible`, `user_id`, `created_at`) VALUES (:name, :target, :url, :image, :image_mobile, :active, :visible, :user_id, :created_at)');
            $data = array(
              ':name' => $name,
              ':target' => $target,
              ':url' => $url,
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Agregar Slides</li>
      </ol>
    </section>
        ...
        <div class="box-body">
          ...
          <form role="form" method="post" name="form">
           ...
           <div class="col-sm-3">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <input class="form-control" name="url" placeholder="Link" type="text">
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <input class="form-control" name="image_mobile" placeholder="Subir Imagen" type="text" readonly="true">
                </div>
            </div>
