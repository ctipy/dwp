                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($rows['image'] != null) { ?>
                                        <img src="../images/clientes/<?php echo $rows['image']; ?>" alt="<?php echo $rows['name']; ?>" width="40">
                                    <?php } else { ?>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="clientes.edit.php?id=<?php echo $rows['id']; ?>">
                                            <button type="button" class="btn btn-warning"><i class="fa fa-pencil"></i></button>
                                        </a>
                                        <a href="clientes.delete.php?id=<?php echo $rows['id']; ?>">
