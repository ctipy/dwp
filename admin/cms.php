...
<head>
    ...
    <title>Gestión de contenidos | Panel de Administración</title>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($rows['image'] != null) { ?>
                                        <img src="../images/cms/<?php echo $rows['image']; ?>" alt="<?php echo $rows['name']; ?>" width="40">
                                    <?php } else { ?>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="cms.edit.php?id=<?php echo $rows['id']; ?>">
                                            <button type="button" class="btn btn-warning"><i class="fa fa-pencil"></i></button>
                                        </a>
                                        <a href="cms.delete.php?id=<?php echo $rows['id']; ?>">
